...
export default function QuoteCard({
    ...
    // const showProvidedAddon = toggleProvidedAddon ? 1: quote['AddOnPremium'].length - 1
    // const showNotProvidedAddon = toggleNotProvidedAddon ? 1: quote['AddOnPremium'].length - 1
    ...
    const card = (
        <Box
            sx={{ width: '100%', flexGrow: 1, paddingTop: '0px' }}
            className="quotation-list"
        >
            <div className="flex flex-col md:flex-row">
                <Grid item className="IC list-data">
                    {callFromCustomer && (
                    ...
                    <div className="flex flex-col items-left absolute top-0 left-0 p-1">
                        {!callFromCustomer && isPreferredQuote && (
                            <VerifiedIcon />
                        )}
                    </div>
                    {/* <div className="flex flex-col m-auto items-center gap-[6px]">
                        {!callFromCustomer && !isPreferredQuote && (
                            <VerifiedIcon />
                        )}
                    </div> */}
                    <div className="flex flex-col m-auto items-center gap-[6px]">
                        ...
                        <span className="StarRatings ">Star Ratings</span> */}
                    </div>
                </Grid>
                <Grid container>
                    <Grid
                        ...
                        <div className="flex flex-col py-4 md:flex-row">
                            <div className="w-full md:w-3/4">
                                ...
                                >
                                    ...
                                    >
                                        <span className="flex flex-row items-center ml-0">
                                            <svg
                                                width="14"
                                                height="15"
                                                viewBox="0 0 14 15"
                                            ...
                                            <span
                                                className="text-sm ml-1 underline cursor-pointer"
                                                onClick={(e) => {
                                                    e.preventDefault()
                                    ...
                                    >
                                        ...
                                        <label className="flex font-semibold my-2">
                                            <>
                                                <span className="pr-2">
                                                    <svg
                                                        width="20"
                                                ...
                                                <span>
                                                    {addOns?.filter((x) => {
                                                        ...
                                                        ? `Addons - Provided(${quote['AddOnPremium'].length})/Not Provided(${addOnsNotProvided.length})`
                                                        : 'Selected Addons'}{' '}
                                                </span>{' '}
                                            </>
                                        </label>
                            ...
                            <div className="w-full md:w-1/4 happp">
                                <Stack sx={{ px: 6 }}>
                                    {!callFromCustomer &&
                                    ...
                                    <p className="text-sm gstText">

                                        (Incl. {quote['TOTALGST_PER']}% GST-{' '}
                                        <span>&#8377;</span>
                                        <span>{quote['TOTALGSTPREMIUM']}</span>)
                                    </p>
                                    {callFromCustomer ||
                                                ...
                                                >
                                                    <div className="flex flex-col quotation-buynow-btn">
                                                        ...
                                                        <div className="text-right">
                                                            <label className="text-sm font-light text-white leading-4 pr-2">
                                                                {/* <span>
                                                                    BUY NOW
                                                                </span> */}
                                                            </label>
