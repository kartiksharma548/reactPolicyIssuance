...
import { updateHOProposalStatus } from '../../services/policyServices/proposerService'
import ConfirmDialog from '../../components/common/confirmDialog'

function AVApprovalList({ approvalList, refresh }: any) {
    ...
    const ApproveReject = (approvalData: BreakinMDLType, action: string) => {
